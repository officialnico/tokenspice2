...
class BalancerMath:
    ...
    def calc_single_out_given_pool_in(
        ...
        pool_amount_in_after_exit_fee = pool_amount_in * (1 - EXIT_FEE)
        new_pool_supply = pool_supply - pool_amount_in_after_exit_fee
        pool_ratio = new_pool_supply / pool_supply
        # newBalTo = pool_ratio ^ (1 / weightTo) * balTo
        token_out_ratio = pow(pool_ratio, (BONE / normalized_weight))
        ...
        token_amount_out = token_amount_out_before_swap_fee * (BONE - zaz)
        return token_amount_out
    ...
    def calc_pool_in_given_single_out(
        ...
        zoo = BONE - normalized_weight
        zar = zoo * swap_fee
        token_amount_out_before_swap_fee = (token_amount_out / (BONE - zar))
        ...
        pool_amount_in = pool_amount_in_after_exit_fee / (BONE - EXIT_FEE)
        return pool_amount_in

print(BalancerMath.calc_spot_price(10,0.5,10,0.5,0.3))